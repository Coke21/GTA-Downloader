...
namespace GTADownloader
{
    class DataProperties
    {
        ...
        public static string GetProgramDataFolderPathOLD { get; } = @Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "/../Local/GTADownloader";
        public static string GetProgramDataFolderPathNEW { get; } = @Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "/../Roaming/GTADownloader";

    ...
    class CheckForUpdate
    {
        public static async Task UpdateAsync(CancellationToken cancellationToken)
        {
            ...
            await Task.Run(() =>
            {
                ...
                {
                    var request = DataHelper.GetFileRequest(file.Item1, "size");
                ...
                long? gtaSizeProgramOnline = DataHelper.GetFileRequest(Data.programID, "size").Execute().Size;
                ...
                else
                {
                    ...
                    win.Dispatcher.Invoke(() => win.ReadChangelogName.Visibility = Visibility.Visible);
                }

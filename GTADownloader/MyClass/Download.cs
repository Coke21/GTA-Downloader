...
namespace GTADownloader
{
    class Download
    {
        ...
        public static async Task FileAsync(string fileID, CancellationToken cancellationToken, string option = "missionFile")
        {
            ...
            {
                win.Dispatcher.Invoke(() => DataHelper.ButtonsOption("beforeDownload"));
                    ...
                    request.MediaDownloader.ProgressChanged += (IDownloadProgress progress) =>
                    {
                        switch (progress.Status)
                        {
                            ...
                            case DownloadStatus.Completed:
                                ...
                                win.Dispatcher.Invoke(() => Notify(option == "missionFile" ? $"{fileName} has been downloaded!" : "The updated version of GTA program has been downloaded!", Brushes.ForestGreen));
                                break;
